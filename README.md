...
Convert app over to use GraphQL & Apollo Client instead of Redux for local state management 


## After you fork and clone:
```bash
~ git clone https://github.com/oussamabouchikhi/crwn-shop-graphql.git
```
